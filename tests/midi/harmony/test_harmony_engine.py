...
class TestHarmonyEngine:
    ...
    def test_process_melody_note_on_enabled(self):
        ...
        self.engine.state.intervals = [4, 7]
    ...
    def test_voice_limit_respected(self):
        ...
        self.engine.state.enabled = True
        self.engine.state.intervals = [3, 4, 5, 7, 12]  # 5 intervals
    ...
    def test_chromatic_scale_harmony(self):
        ...
        self.engine.state.enabled = True
        self.engine.state.intervals = [3, 4, 5, 7]
...
class TestHarmonyEngineVelocityAndChannel:
    ...
    def test_velocity_preserved(self):
        """Test that input velocity is used for harmony notes."""
        self.engine.state.intervals = [4]
        velocity = 85
