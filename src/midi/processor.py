...
class MidiProcessor:
    ...
    def _update_arp_pattern(self) -> None:
        """Update arpeggiator pattern (placeholder for future pattern regeneration)."""
        # Pattern notes are dynamically generated by the arp engine based on held notes
        # This method can be extended in the future to recalculate specific patterns
        pass
